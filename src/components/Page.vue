<template>
  <div>
    <span class="txt_record_idx" v-if="page.totalAmount > 0">
      ...
      >条，总计<span class="cs_text_danger">{{ page.totalAmount }}</span
      >条记录
    </span>
    <!--上一页-->
    <button
    ...
    <input
      ...
      @blur="pageJump = checkPositiveInt($event)"
    />
...
.btn_page_up:hover {
  background: #009999 url("../assets/image/icon_pre_focus.png") no-repeat center;
  background-size: 10px 10px;
...
.btn_page_up_disable {
  ...
  border: 1px solid #cccccc;
  border-radius: 4px;
  background: #cccccc url("../assets/image/icon_pre_focus.png") no-repeat center;
  background-size: 10px 10px;
  vertical-align: top;
}
...
.btn_page_down {
  ...
  border: 1px solid #cccccc;
  border-radius: 4px;
  background: #ffffff url("../assets/image/icon_next.png") no-repeat center;
  background-size: 10px 10px;
  vertical-align: top;
}
...
.btn_page_down_disable {
  ...
  border: 1px solid #cccccc;
  border-radius: 4px;
  background: #cccccc url("../assets/image/icon_next_focus.png") no-repeat
    center;
  background-size: 10px 10px;
  vertical-align: top;
}
